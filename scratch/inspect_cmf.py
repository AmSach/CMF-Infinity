...
from scratch.test_compositional_reasoning import generate_hop_batch, DeliberativeContinuousMeaningField, CMFConfig, VAL_COLORS, VOCAB_SIZE
...
# Train for 200 steps
opt = torch.optim.AdamW(cmf_model.parameters(), lr=1e-3)
